...
***********************************************************************/
// create function names smoothieMachine that takes in an unlitmited number of parmes
let smoothieMachine =function (...first){
  let allIngredients = [...first]
let recipe = "I'm having a smoothie with "
  return function ( ...ingredients) {
    //let allIngredients = [...first]
    // allIngredients.push(...ingredients)
    // first.push(...ingredients)
    allIngredients = allIngredients.concat(ingredients)
    return recipe + allIngredients.join(" and ")
 }
}
// Your code here
let smoothie1 = smoothieMachine();
